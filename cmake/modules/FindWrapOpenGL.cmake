# Project-local override for Qt's WrapOpenGL finder.
#
# Newer macOS SDKs (e.g. 26.x) no longer ship AGL.framework. Upstream Qt's
# module falls back to linking "-framework AGL" when missing, which breaks
# linking. This override only links AGL when it is present.
...
if(OpenGL_FOUND)
  ...
  if(APPLE)
    ...
    # Only link AGL if the framework exists in the active SDK.
